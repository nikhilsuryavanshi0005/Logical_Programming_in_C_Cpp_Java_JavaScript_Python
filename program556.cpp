...
//                : Address of Buffer which contains _Data
//                : Size of bytes successfully write
            ...
            )
{
    ...
    printf("Number of Bytes that  Allocated :%d\n",size);
    ...
    while(1)
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp("write",Command[0])==0)
            {
                ...
                {
                    printf("ERROR : Unable to write due to Invald Parameters\n");
                }
                ...
                else if (iRet == ERR_PERMISSION_DENIED)
                {
                    ...
                    printf("ERROR : There is No Permission for File\n");
                }
                else if (iRet == ERR_INSUFFICIENT_SPACE)
                {
                    printf("ERROR : Unable to write as thet=re is no space \n");
                }
                else 
                {
        ...
        else if(iCount == 3)
        {
            ...
            if("read",Command[0]== 0)
            {
                ...
                {
                    printf("ERROR : Unable to read due to permission denied\n");
                }
                ...
                {
                    printf("Read Operaton is Succesful\n");
